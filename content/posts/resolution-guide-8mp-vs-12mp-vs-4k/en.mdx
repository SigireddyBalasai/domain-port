...
<img src="/resolution-comparison-diagram.svg" alt="Diagram showing pixel density at 30 feet: 4MP provides approximately 40 pixels on target, 8MP provides 80 pixels, and 12MP (4K) provides 120 pixels, illustrating the diminishing returns beyond 8MP." />
...
<Callout type="warning" title="The hidden costs of 4K">
  4K cameras chew through storage and bandwidth. If you're currently using 4MP cameras and switch to 4K, expect your recording storage needs to **more than double**. That means larger NVR hard drives, more cloud upload bandwidth if you use remote monitoring, and potentially slower playback due to higher data throughput requirements.
</Callout>
