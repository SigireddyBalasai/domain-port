...
<Badge variant="outline">Physics First</Badge> **Energy in = Energy out +
Losses.** No marketing changes this. Size your source for worst-case (shortest
day, coldest temp, highest activity), not best-case.
...
**Marketing vs Reality:** "6-month battery life" = 10 motion events/day, 10s
clips, 70°F, no live view. **Real world:** 20–40 events/day + 5 live views =
**2–6 weeks**. Always derate 3–5×.
...
<strong>IEEE 802.3af (PoE):</strong> 15.4W at PSE → 12.95W at PD (camera).
Powers most fixed bullets/domes.
<strong>IEEE 802.3at (PoE+):</strong> 30W at PSE → 25.5W at PD. Powers PTZ,
heaters, IR illuminators.
<strong>IEEE 802.3bt (PoE++):</strong> 60W (Type 3) / 90W (Type 4) at PSE → 51W
/ 71W at PD. Powers speed domes, multi-sensor, wipers/heaters.

<strong>Cable:</strong> Cat5e minimum (Cat6/6a for PoE++). Max 100 m (328 ft)
per segment.
<strong>Topology:</strong> Camera → Cat5e/6 → PoE Switch (or NVR with PoE ports)
→ UPS → Grid.
<strong>Voltage:</strong> 44–57V DC on wire pairs (Mode A: data pairs / Mode B:
spare pairs). Camera DC-DC converts to 12V/5V/3.3V internally.
...
<strong>Rule:</strong> UPS must cover
<strong>all PoE switch ports + NVR + router</strong> for target runtime.
...
| <strong>Total (12-cam system)</strong> | <strong>~170W</strong> | <strong>680 Wh</strong> | <strong>2,040 Wh</strong> | <strong>4,080 Wh</strong> |

<strong>UPS Recommendation:</strong>

<ul>
  <li>
    <strong>&lt;4 hrs:</strong> CyberPower CP1500PFCLCD (1,500 VA / 1,050 Wh) —
    $200
  </li>
  <li>
    <strong>8–12 hrs:</strong> APC SMT1500RM2UC + external battery pack — $600+
  </li>
  <li>
    <strong>24+ hrs:</strong> 48V LiFePO₄ server rack battery (5–10 kWh) +
    Victron inverter/charger — $2,000+
  </li>
</ul>

<strong>Pro Tip:</strong> Put PoE switch + NVR + router on
<strong>same UPS</strong>. Camera-side UPS (per-camera) exists but costs 5× more
for same runtime.
...
**Chemistry:** Almost all consumer battery cams use **Li-ion (NMC/LCO),
3.6–3.7V nominal, 4.2V max**. Not LiFePO₄. This matters for cold.
...
<ol>
  <li>
    <strong>Tx Power Dominates:</strong> Wi-Fi radio at +17 dBm = 300–500 mA @
    3.7V. 10s
  </li>
</ol>
clip = 5–10 mAh. 30 clips = 150–300 mAh/day =
<strong>3–6% of 5,000 mAh/day</strong>.
<ol>
  <li>
    <strong>IR LEDs:</strong> 850 nm IR at 100 ft = 1–2W for 30s/clip. 30 clips
    =
  </li>
</ol>
<ol>
  <li>
    <strong>PIR Wake + DSP:</strong> 50–100 mA for 2–5s per event. Negligible
    alone, adds up.
  </li>
  <li>
    <strong>Cold Temp:</strong> Li-ion{" "}
    <strong>internal resistance doubles resistance at 32°F (0°C)</strong>.
    Voltage sags under Tx load → BMS cuts off at 3.0V → "dead" battery at 40%
    SoC. <strong>Capacity at 14°F (-10°C) ≈ 50% of 70°F.</strong>
  </li>
  <li>
    <strong>Self-Discharge:</strong> 2–5%/month. Negligible vs active drain.
  </li>
  <li>
    <strong>Live View:</strong> 5 min live view = 30+ clips worth of energy.{" "}
    <strong>Avoid daily live checks.</strong>
  </li>
</ol>
  ...
  <AccordionItem value="charging">
    ...
    <AccordionContent>
      ...
      <strong>Don't wait for 0%.</strong> Li-ion hates deep discharge. Charge at 20–30%.
      <strong>Solar Panel Sizing:</strong> Panel (W) ≥ Camera Avg Draw (W) × 3
      (winter/cloudy) ÷ Peak Sun Hours (worst month). - Example: Argus 4 Pro avg
        1.5W → 4.5W needed. Worst month (Dec, Zone 5) = 1.5 peak hrs → <strong>3W panel
      minimum, 6W recommended</strong>. <strong>USB-C PD Trigger Cables:</strong> Reolink/Argus/Eufy
      accept 5V/9V/12V/15V/20V via PD negotiation. Use 12V→USB-C PD trigger
      cable to charge from 12V RV/house bank directly (90% efficient vs 12V→120V
      inverter→5V adapter at 60%). <strong>Dual-Battery Rotation:</strong> Buy spare pack.
      Swap charged for depleted. Zero downtime. Only works with user-removable
      packs (Reolink, Blink, some Ring).
...
**Solar is a battery charger, not a power source.** Size the **battery** for
autonomy (days without sun). Size the **panel** to recharge that battery in 1
good day.
...
<strong>December Solstice (Zone 5, 42°N):</strong>

<ul>
  <li>
    Peak Sun Hours: <strong>1.0–1.5</strong> (vs 5.5 in June)
  </li>
  <li>
    Panel output at 30° tilt: <strong>15–20% of STC rating</strong>
  </li>
  <li>
    Snow cover: <strong>0% output</strong> until cleared (auto-heated panels
    exist: 5–10W parasitic)
  </li>
  <li>
    Battery at 14°F:{" "}
    <strong>Li-ion = 50% capacity; LiFePO₄ = 80% capacity</strong>
  </li>
</ul>

<strong>Survival Strategies:</strong>

<ol>
  <li>
    <strong>Oversize panel 3–4×</strong> summer math (60W → 180–240W array)
  </li>
  <li>
    <strong>LiFePO₄ battery</strong> (not Li-ion) — charges at -4°F with BMS
    heater
  </li>
  <li>
    <strong>Reduce camera duty cycle:</strong> Motion-only, lower resolution,
    shorter clips, disable IR (use ambient light)
  </li>
  <li>
    <strong>Backup charge:</strong> 12V→USB-C PD trigger cable from
    vehicle/genny monthly
  </li>
  <li>
    <strong>Accept downtime:</strong> Design for 90% uptime, not 100%. 3–5 days
    dark/yr is normal.
  </li>
</ol>
...
**Hidden Cost:** Truck rolls. Battery cam dies at 3 AM → you drive 30 min to
swap = $50/time. PoE + UPS = 0 truck rolls for power. Factor $50 × expected
failures/yr.
